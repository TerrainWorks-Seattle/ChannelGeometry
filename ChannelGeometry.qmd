...
```{r, echo=FALSE, results='hide'}
##plotting river shapefile
sprague <- st_read("/Users/alexahaucke/Documents/Klamath River Project/Sprague_reaches_Nov_2024/reach_WIPincise.shp")
...
The Oregon Department of Fish and Wildlife has conducted two surveys of the Sprague. The reach survey focused on documenting channel geometry for river reaches, and the habitat survey focused on documenting channel geometry for different habitat units. Our goal is to use these measurements to improve existing channel geometry models and tailor them to the Sprague. Let's examine the reach survey data.
```{r}
